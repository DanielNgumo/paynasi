        ...
        <div className="text-white space-y-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">Inspect Before You Pay</h3>
                <p className="text-sm text-blue-100">Release funds only after confirming the delivery meets your expectations.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-[#17b5a7] flex-shrink-0" />
              <div>
                <h3 className="text-lg font-semibold text-white">Track Your Delivery</h3>
                <p className="text-sm text-blue-100">Stay updated with real-time notifications at every step of the transaction.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-[#17b5a7] flex-shrink-0" />
              <div>
                <h3 className="text-lg font-semibold text-white">Total Fund Protection</h3>
                <p className="text-sm text-blue-100">Your money is held safely in escrow until you’re satisfied with your purchase.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-[#17b5a7] flex-shrink-0" />
              <div>
                <h3 className="text-lg font-semibold text-white">Verify Before You Buy</h3>
                <p className="text-sm text-blue-100">Avoid scams by ensuring funds are only released when you’re confident.</p>
              </div>
            </div>
          </div>
