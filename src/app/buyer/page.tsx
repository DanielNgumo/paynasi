    ...
    <section className="relative bg-gradient-to-br from-[#15479e] via-[#1e5bb8] to-[#17b5a7] overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 opacity-10">
        <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <defs>
            <pattern id="grid-buyer" width="10" height="10" patternUnits="userSpaceOnUse">
              <path d="M 10 0 L 0 0 0 10" fill="none" stroke="white" strokeWidth="0.5" />
            </pattern>
          </defs>
          <rect width="100" height="100" fill="url(#grid-buyer)" />
        </svg>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 pt-2 sm:pt-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="min-w-0">
                <h3 className="text-base sm:text-lg font-semibold text-white leading-tight">Inspect Before You Pay</h3>
                <p className="text-sm text-blue-100 mt-1">Release funds only after confirming the delivery meets your expectations.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-[#17b5a7] flex-shrink-0 mt-0.5" />
              <div className="min-w-0">
                <h3 className="text-base sm:text-lg font-semibold text-white leading-tight">Track Your Delivery</h3>
                <p className="text-sm text-blue-100 mt-1">Stay updated with real-time notifications at every step of the transaction.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-[#17b5a7] flex-shrink-0 mt-0.5" />
