        ...
        <div className="text-white space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 font-medium">
              Stay informed with real-time delivery updates.
            </p>
          </div>

          {/* Description */}
          <p className="text-lg text-blue-100 leading-relaxed max-w-2xl">
            PayNasi keeps you updated every step of the way as the seller delivers your product or service. Our real-time tracking ensures transparency and peace of mind throughout the transaction.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">Receive instant notifications as your order progresses.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-[#17b5a7] flex-shrink-0" />
              <div>
                <h3 className="text-lg font-semibold text-white">Complete Transparency</h3>
                <p className="text-sm text-blue-100">Know exactly when the seller ships and when your delivery is on its way.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-[#17b5a7] flex-shrink-0" />
              <div>
                <h3 className="text-lg font-semibold text-white">Peace of Mind</h3>
                <p className="text-sm text-blue-100">Stay confident with clear updates on your transaction status.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="h-5 w-5 text-[#17b5a7] flex-shrink-0" />
              <div>
                <h3 className="text-lg font-semibold text-white">Easy Status Checks</h3>
                <p className="text-sm text-blue-100">Access your transaction progress anytime through the PayNasi app.</p>
              </div>
            </div>
          </div>
...
export default EscrowTrackPage;